namespace CADmotelerosco
{
    ...
    public class CADproducto
    {
        ...
        public static CADproducto ConsultarProducto_x_Barra(long Barra)
        {
            ...
            DSmotelerosco.ProductoDataTable miTabla = adaptador.ConsultarProducto_x_Barra(Barra);
            if (miTabla.Rows.Count == 0) return miProducto;
            DSmotelerosco.ProductoRow miRegistro = (DSmotelerosco.ProductoRow)miTabla.Rows[0];
        ...
        */
        ...
        {
            CADproducto miProducto = null;
            DSmotelerosco.ProductoDataTable miTabla = adaptador.ConsultarProducto_x_IDproducto(IDProducto);
            if (miTabla.Rows.Count == 0) return miProducto;
            DSmotelerosco.ProductoRow miRegistro = (DSmotelerosco.ProductoRow)miTabla.Rows[0];
            miProducto = new CADproducto();
        ...
        */
        ...
        {
            CADproducto miProducto = null;
            DSmotelerosco.ProductoDataTable miTabla = adaptador.ConsultaByIDProducto(IDProducto);
            if (miTabla.Rows.Count == 0) return miProducto;
            DSmotelerosco.ProductoRow miRegistro = (DSmotelerosco.ProductoRow)miTabla.Rows[0];
            miProducto = new CADproducto();
            miProducto.IDProducto = miRegistro.IDProducto;
        ...
        */
        ...
        /*
        public static DSmotelerosco.ProductoDataTable ConsultarProductosID2()
        {
        ...
        */
        ...
        /*
         ...
         public static DSmotelerosco.ProductoDataTable ConsultarProducto_x_IDdepartamento(int IDdepartamento)
         {
